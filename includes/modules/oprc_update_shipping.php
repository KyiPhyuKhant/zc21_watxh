...
if (((!isset($_POST['oprcaction']) || $_POST['oprcaction'] != 'process') && (!isset($_GET['oprcaction']) || $_GET['oprcaction'] != 'process')) || !isset($_SESSION['shipping']) || $recalculate_shipping_cost) {
        ...
        if ((isset($_POST['shipping'])) && (strpos($_POST['shipping'], '_'))) {
            ...
            if (is_object(${$module}) || ($_SESSION['shipping']['id'] == 'free_free')) {
                if ($_SESSION['shipping']['id'] == 'free_free') {
                    ...
                    $error = isset($quote['error']) ? $quote['error'] : null; // keep error, to prevent infinate redirect
                    $quote = oprc_get_shipping_quotes($shipping_modules, $method, $module);
                    $quote['error'] = $error;
                }
