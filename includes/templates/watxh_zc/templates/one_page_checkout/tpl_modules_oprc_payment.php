...
<?php //if (isset($credit_covers) && !$credit_covers && (!isset($_SESSION['credit_covers']) || !$_SESSION['credit_covers'])) { ?>
  ...
  <div class="boxContents">
    ...
    <span class="nmx-de"><?php echo (OPRC_CSS_BUTTONS == 'false' ? zen_image_submit(BUTTON_IMAGE_CONTINUE_CHECKOUT, BUTTON_CONTINUE_ALT, 'submit', isset($button_class) ? $button_class : '') : zenCssButton(BUTTON_IMAGE_CONTINUE_CHECKOUT, BUTTON_CONTINUE_ALT, 'submit', isset($button_class) ? $button_class : '')); ?></span>
      <span class="nmx-ml"><?php echo (OPRC_CSS_BUTTONS == 'false' ? zen_image_submit(BUTTON_IMAGE_CONTINUE_CHECKOUT, BUTTON_CONTINUE_ALT, 'submit', isset($button_class) ? $button_class : '') : zenCssButton(BUTTON_IMAGE_CONTINUE_CHECKOUT, BUTTON_CONTINUE_ALT, 'submit', isset($button_class) ? $button_class : '')); ?></span>
    </div>
  </div>
