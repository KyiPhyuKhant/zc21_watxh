      ...
      <div class="nmx-form-address">
        ...
        <div class="nmx-row nmx-form-group">
          ...
          <div class="nmx-col-6 <?php echo $addclass; ?>">
            ...
            <?php echo zen_get_country_list('zone_country_id_shipping', (isset($selected_country_shipping) ? $selected_country_shipping : ''), 'class="nmx-fw" id="country_shipping" ' . ($flag_show_pulldown_states_shipping == true ? 'onchange="update_zone_shipping(this.form);"' : '')); ?>
