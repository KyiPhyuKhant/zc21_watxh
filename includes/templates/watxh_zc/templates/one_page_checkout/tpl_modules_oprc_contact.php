        ...
        <div class="nmx-row nmx-form-group">
            <div class="nmx-col-6">
                <label for="email-address-register">
                    ...
                    if (zen_not_null(ENTRY_EMAIL_ADDRESS_TEXT)) {
                        echo '<span class="alert">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>';
                    }
                    ?>
                </label>
                <?php
            ...
            <div id="passwordField"
                ...
                <div class="nmx-col-6">
                    <label for="password-register">
                        <?php
                        echo ENTRY_PASSWORD;
                        if (zen_not_null(ENTRY_PASSWORD_TEXT)) {
                            echo '<span class="alert">' . ENTRY_PASSWORD_TEXT . '</span>';
                        }
                        ?>
                    </label>
                    <?php
                ...
                <div class="nmx-col-6">
                    <label for="password-confirmation">
                        ...
                        if (zen_not_null(ENTRY_PASSWORD_CONFIRMATION_TEXT)) {
                            echo '<span class="alert">' . ENTRY_PASSWORD_CONFIRMATION_TEXT . '</span>';
                        }
                        ?>
                    </label>
                    <?php
            ...
            <div class="nmx-row nmx-form-group">
                <div class="nmx-col-6">
                    <label for="telephone">
                        ...
                        if (zen_not_null(ENTRY_TELEPHONE_NUMBER_TEXT)) {
                            echo '<span class="alert">' . ENTRY_TELEPHONE_NUMBER_TEXT . '</span>';
                        }
                        ?>
                    </label>
                    <?php
            ...
            <div class="nmx-row">
                <div class="nmx-col-6">
                    <label>
                        ...
                        if (zen_not_null(ENTRY_DATE_OF_BIRTH_TEXT)) {
                            echo '<span class="alert">' . ENTRY_DATE_OF_BIRTH_TEXT . '</span>';
                        }
                        ?>
                    </label>
                    <?php
