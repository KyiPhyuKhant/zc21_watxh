...
<?php
  ...
  if (FACEBOOK_LIKE_BUTTON_ALIGNMENT == 'left') {
    $style = 'float: left;';
  } elseif (FACEBOOK_LIKE_BUTTON_ALIGNMENT == 'right') {
    $style = 'float: right;';
  } else {
    $style = '';
  }
...
<iframe src="http://www.facebook.com/widgets/like.php?href=<?php echo $iframe_url; ?>"
 ...
 style="<?php echo $style ?>border: none; overflow: hidden; width: <?php echo FACEBOOK_LIKE_BUTTON_WIDTH; ?>px; height: <?php echo $height; ?>px;" allowTransparency="true"></iframe>
...
//--></script>
<fb:like href="<?php echo $og_url; ?>" layout="<?php echo FACEBOOK_LIKE_BUTTON_LAYOUT_STYLE; ?>" show_faces="<?php echo FACEBOOK_LIKE_BUTTON_SHOW_FACES; ?>" width="<?php echo FACEBOOK_LIKE_BUTTON_WIDTH; ?>" action="<?php echo FACEBOOK_LIKE_BUTTON_ACTION; ?>" font="<?php FACEBOOK_LIKE_BUTTON_FONT; ?>" send="<?php echo FACEBOOK_LIKE_BUTTON_SEND; ?>" colorscheme="<?php echo FACEBOOK_LIKE_BUTTON_COLOR_SCHEME; ?>"<?php echo $style ?>></fb:like>
