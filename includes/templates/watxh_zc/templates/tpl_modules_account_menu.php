...
<ul id="account-menu" class="list">
	<li class="account-history first-link"><?php echo ' <a href="' . zen_href_link(FILENAME_ACCOUNT_HISTORY, '', 'SSL') . '">' . MY_ACCOUNT_ORDER_HISTORY . '</a>'; ?></li>
		...
		<li class="change-password"><?php echo ' <a href="' . zen_href_link(FILENAME_ACCOUNT_PASSWORD, '', 'SSL') . '">' . MY_ACCOUNT_PASSWORD . '</a>'; ?></li>
		<li class="saved-credit-cards last-link"><?php echo ' <a href="' . zen_href_link(FILENAME_ACCOUNT_SAVED_CREDIT_CARDS, '', 'SSL') . '">' . MY_ACCOUNT_SAVED_CREDIT_CARDS . '</a>'; ?></li>
</ul>
