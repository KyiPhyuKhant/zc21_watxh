...
<?php
// avoid “undefined variable” notices later on
$getoption_set       = isset($getoption_set)       ? $getoption_set       : [];
$get_option_variable = isset($get_option_variable) ? $get_option_variable : '';
?>
...
<?php
  ...
  // draw sort
  echo zen_draw_hidden_field('sort', isset($_GET['sort']) ? $_GET['sort'] : '');
