...
<?php
// Constants for Fast/Easy Checkout
if (!defined('FEC_CSS_BUTTONS')) {
    define('FEC_CSS_BUTTONS', 'false'); 
}
?>
<?php
...
<?php
    ...
    //}
    if ($addresses_count > 1 && !(isset($_SESSION['COWOA']) && $_SESSION['COWOA']) && MAX_ADDRESS_BOOK_ENTRIES > 1) {
?>
