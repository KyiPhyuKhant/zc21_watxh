            ...
            <div class="nmx-panel-body">
              ...
              <div class="creditcard-form">
                ...
                <div id="js-address_entry" class="nmx-address__entry nmx-form-group nmx-hidden">
                  <?php require($template->get_template_dir('tpl_modules_account_credit_cards_address_book_details.php', DIR_WS_TEMPLATE, $current_page_base,'templates'). '/' . 'tpl_modules_account_credit_cards_address_book_details.php'); ?>
                </div>
              </div>
              <div class="nmx-buttons">
              ...
              <?php } ?>
                <ul class="nmx-address-details nmx-clist">
                  ...
                  <li>
                    ...
                    <span><?php echo zen_not_null($credit_card['expiry']) ? substr($credit_card['expiry'], 0, 2) . '/'.substr($credit_card['expiry'], -2) : ''; ?></span>
                  </li>
                  <!-- 
                  <li>
