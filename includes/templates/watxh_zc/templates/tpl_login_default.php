...
<div class="login">
  <form class="login-form" action="<?php echo zen_href_link(FILENAME_LOGIN, 'action=process', 'SSL'); ?>" method="post">
    ...
    <button>Login</button>
    <p>Don't have an Account? <a href="<?php echo zen_href_link('create_account'); ?>">Create One</a></p>
...
<!-- 
  <div id="register">
   ...
   <fieldset>
    <h2><?php //echo HEADING_NEW_CUSTOMER; 
        ?></h2>
    ...
    ?>
    <div class="information"><?php //echo TEXT_NEW_CUSTOMER_INTRODUCTION;  
                              ?></div>
