...
if(defined('OPRC_DISPLAY_PAYPAL_BUTTON_ON_CHECKOUT') && OPRC_DISPLAY_PAYPAL_BUTTON_ON_CHECKOUT == 'true') $loader['jscript_files']['jquery/jquery_oprc_express_paypal.php'] = 13;
$loaders[] = $loader;
