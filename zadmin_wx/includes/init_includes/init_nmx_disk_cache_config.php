...
$module_constant = 'NMX_DISK_CACHE_VERSION';
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/nmx_disk_cache';
$module_name = "Numinix Disk Cache";
$zencart_com_plugin_id = 1777; // from zencart.com plugins - Leave Zero not to check
...
if($_POST['securityToken'] != ''){
    ...
    $nmx_disk_cache->adminCacheClear($php_file);
}