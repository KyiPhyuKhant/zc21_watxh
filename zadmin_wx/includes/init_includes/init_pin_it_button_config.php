<?php
  ...
  while ($pin_it_button_version != $current_version) {
    switch($pin_it_button_version) {
      ...
      case '1.2.3':
        // perform upgrade
        if (file_exists(DIR_WS_INCLUDES . 'installers/pin_it_button/1_2_4.php')) {
          include_once(DIR_WS_INCLUDES . 'installers/pin_it_button/1_2_4.php');
          $pin_it_button_version = '1.2.4';          
		  break;
        } else {
          break 2;
		}
      case '1.2.4':
        // perform upgrade
        if (file_exists(DIR_WS_INCLUDES . 'installers/pin_it_button/1_3_0.php')) {
          include_once(DIR_WS_INCLUDES . 'installers/pin_it_button/1_3_0.php');
          $pin_it_button_version = '1.2.4';          
          break;
        } else {
          break 2;
