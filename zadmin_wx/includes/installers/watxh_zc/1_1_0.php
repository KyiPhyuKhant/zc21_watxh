<?php
$template_options = $db->Execute("SELECT template_configuration_group_id FROM " . TABLE_TEMPLATE_CONFIG_GROUP . " WHERE template_configuration_group_title = 'watxh_zc' ORDER BY template_configuration_group_id ASC;");
...
$db->Execute("INSERT INTO " . TABLE_TEMPLATE_CONFIG_GROUP . " (template_configuration_group_title, template_group_description, sort_order, visible) VALUES ('watxh_zc', 'Set Watxh ZC Template Options', '1', '1');");
...
if ($zc150 && function_exists('zen_page_key_exists') && function_exists('zen_register_admin_page')) // continue Zen Cart 1.5.0
{
	...
	{
		$configuration          = $db->Execute("SELECT template_configuration_group_id FROM " . TABLE_TEMPLATE_CONFIG . " WHERE template_configuration_key = 'WATCH_ZC_VERSION' LIMIT 1;");
